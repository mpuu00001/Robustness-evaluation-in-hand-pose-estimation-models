...
if __name__ == "__main__":
    ...
    # document_level_occlusion_results(dataset='FreiHand')scale
    # document_different_exposure_rate_results(dataset='FreiHand')
    # document_different_motion_blur_results(dataset='FreiHand')
    # document_baseline_results_filtered_naked_hands(dataset='FreiHand')
    ...
    # document_baseline_results_filtered_naked_hands(dataset='CMUhand')
    # document_different_scaling_factor(dataset='CMUhand')
    document_baseline_results_filtered_hands_with_objects(dataset='CMUhand')
